...
from src import run_train_predict, run_train_predict_svm, load_logger_st, Config


st.set_page_config(layout="wide")

st.write("# 使用LSTM预测股票价格")
...
if run_button:
    # 设置日志和图片显示区域
    log_expander = st.expander(expanded=True, label="训练日志")
    ...
    run_train_predict(conf)  # 运行训练和预测
